$(document).ready(function () {
    ...
    let dateString = weekday + ", " + monthday + " " + month + " " + year;
    ...
    $(".icon").click(function () {
        if (confirm("Weet je het zeker?\nJe krijgt hier mogelijk spijt van.")) {
            ...
            $("img").attr(
                "src",
                "https://codecrashers.nl/img/introductie-web/inleiding-web/nicolas-cage.jpg"
            );
            $("a").attr(
                "href",
                "https://codecrashers.nl/img/introductie-web/inleiding-web/wallpaper.jpg"
            );
    ...
    $(".name").click(function () {
        let name = prompt("Wat is je naam", "Nick Cage");
        $(this).text(name);
    });
});
